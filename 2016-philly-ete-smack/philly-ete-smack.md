...
&nbsp;<p>
### [Evan Chan](https://twitter.com/Evanfchan)
### April 2016
...
- [@evanfchan](https://twitter.com/Evanfchan) | [evan@tuplejump.com](mailto:evan@tuplejump.com)
...
### Rescuing struggling big data projects
### with innovative, effective solutions
...
KafkaStrams streams = new KafkaStreams(builder, props);
streams.start();
```
...
## <span class="scalared">NoLambda</span> / SNACK stack for
## Real-Time + AdHoc + Deep Analytics
